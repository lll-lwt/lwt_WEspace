import torch
from model.heads.head_cmtsk import *
from model.ptavitssg2.ptavit3d   import PTAViTStage3D_no_down
...
class head_cmtsk_3D(torch.nn.Module):
    def __init__(self, nfilters, NClasses, spatial_size=512, scales=(4,8), norm_type = 'GroupNorm', norm_groups=4, segm_act ='sigmoid', nblocks3D=2):
        super().__init__()
